...
class DummyMainMyPageScreenViewModel() : SettingMyPageScreenViewModel() {
    // 필요한 상태나 메서드를 정의
}

class DummySettingBaseViewModel() : SettingBaseViewModel() {
    // 필요한 상태나 메서드를 정의
}

class DummySettingDailyScreenViewModel() : SettingDailyScreenViewModel() {
    // 필요한 상태나 메서드를 정의
}